...
export default class DocumentChecklistOfferAcceptanceInternalFileUpload extends NavigationMixin(LightningElement) {
    @api checklist;
    @api uploadFile;
    @api fileExtension;
    ...
    saveDocument() {
        ...
        saveFileAndContactDocumentChecklist({
            ...
            opportunityId : this.checklist.fields.Opportunity__c.value,
