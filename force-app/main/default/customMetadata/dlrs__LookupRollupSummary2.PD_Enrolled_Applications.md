...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>PD - Enrolled Applications</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Applications_Enrolled_Count__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Professional Development field.

Count the number of registered applications linked to a parent case record.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Enquiry_Number__c
status__c</value>
    </values>
    <values>
        <field>dlrs__RelationshipCriteria__c</field>
        <value xsi:type="xsd:string">enquiry_number__r.recordtype.developername = &apos;Professional_Development&apos; AND status__c = &apos;Registered&apos;</value>
    </values>
    <values>
        <field>dlrs__RelationshipField__c</field>
        <value xsi:type="xsd:string">Enquiry_Number__c</value>
    </values>
    <values>
