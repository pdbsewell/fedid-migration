({
	validateValues : function(component, event, helper) {
	    //Show loader
	    component.set('v.showGeneralEnquirySpinner', true);
	    ...
	    var topicField = component.find('topicField');
	    ...
	    if(component.get('v.doContactExist') && 
	       component.get('v.selectedProgram') && component.get('v.selectedTopic') && component.get('v.enquiryDescription')){
	    ...
	    //Hide loader
	    component.set('v.showGeneralEnquirySpinner', false);
	},
	...
	saveEnquiry : function(component, helper, event) {
		...
		//Initialize Action
        var action = component.get('c.submitGeneralEnquiry');
